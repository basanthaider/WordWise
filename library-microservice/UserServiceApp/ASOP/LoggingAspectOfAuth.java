...
public class LoggingAspectOfAuth {
    ...
    @Pointcut("execution(* com.project.librarySystem.auth.login.controller..*(..))")
    public void loggingPointCutLogin(){}

    @Pointcut("execution(* com.project.librarySystem.auth.register.controller..*(..))")
    ...
    @AfterReturning(
            value = "execution(* com.project.librarySystem.auth.login.controller..*(..))",
